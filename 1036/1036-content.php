...
<div class="type-1036">
    <div class="container">
      ...
      <div class="col-md-3 col-sm-6 col-img coll">
                <img src="<?php echo $url_path; ?>/images/Stocksy_txpcd1dc0eemKP100_Medium_1204406-683x1024.jpg" alt="" class = "image"/>
            </div>

      </div>
      <div class="img">
      <div class="col-md-3 col-sm-6 col-img coll">
                <img src="<?php echo $url_path; ?>/images/Stocksy_txpcd1dc0eemKP100_Medium_1000349-683x1024.jpg" alt="" class = "image"/>  
      </div>
    </div>
            </div>
        </div>
